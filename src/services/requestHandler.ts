...
export const doGet = async <T>(
    ...
    return await doRequest(() => axiosInstance.get(setBaseUrl(path)), parser);
};
...
export const doPost = async <T>(
    ...
    return await doRequest(
        () => axiosInstance.post(setBaseUrl(path), body),
        parser
    );
};
...
export const doPut = async <T>(
    ...
    return await doRequest(
        () => axiosInstance.put(setBaseUrl(path), body),
        parser
    );
};
...
export const doPatch = async <T>(
    ...
    return await doRequest(
        () => axiosInstance.patch(setBaseUrl(path), body),
        parser
    );
};
...
export const doDelete = async <T>(
    ...
    return await doRequest(
        () => axiosInstance.delete(setBaseUrl(path)),
        parser
    );
};
